  ...
  return (
    ...
    >
      <svg
        ...
        className="h-8 w-8 my-8 mx-4  lg:w-9 transition"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
        strokeWidth={1.2}
...
export const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed w-full lg:w-[5%] bottom-0 h-[8%] lg:h-screen flex items-center lg:flex-col justify-around lg:justify-between bg-[#4B4A54]`}
    >
